...
## Run #41 — 2026-07-21（🏆 賽事收官 · run_id 2026-07-21T0500Z）

### 決賽賽果
- **#104 決賽**：**西班牙 1:0 阿根廷（加時）** — 西班牙第二次奪冠（繼 2010 年後）
  - Ferran Torres 106 分鐘制勝球（Nico Williams 助攻）
  - Enzo Fernández 90+3 分鐘兩黃變紅離場，加時 10 打 11
  - 觀眾 80,663 人 · 主裁判 Slavko Vinčić
  - 西班牙 0 黃 0 紅｜阿根廷 5 黃 1 紅
  - AI 賽前預測西班牙 2:1，**勝負方向命中，比分未中**（verdict=outcome）
...
### 個人榮譽（本屆）
- **金靴**：麥巴比（法國）10 球
- **射手榜前五**：麥巴比 10、美斯 8、貝寧咸 7、夏蘭特 7、卡尼 6
- **金球候選**：耶馬、托雷斯、梅西

### 同步
- 球員統計：**527 人**（+3：Torres／Williams／Enzo Fernández 等 7 事件）
- 覆盤：93 篇（+#104 決賽覆盤）
- Notion：#104 決賽賽果頁；synced_runs 新增 `2026-07-21T0500Z`
- 新增：**WC2026_TOURNAMENT_SUMMARY.md**（本屆完整賽事總結、AI 表現分析）

### 收官
本屆自動化跑批共 41 次，資料集完整保留於 GitHub。網站 https://tonic-fifa-wc2026.pplx.app 持續公開。收官後不再自動排程。


## Run #40 — 2026-07-19 (決賽日 · run_id 2026-07-19T0500Z)

### 賽果
- **#103 季軍戰**：法國 4:6 英格蘭 — 英格蘭逆轉奪季軍（半場已 4:0，沙卡帽子戲法含 1 十二碼；麥巴比 2 球後成世界盃歷史射手王 22 球）。AI 賽前預測法國 2:1，verdict **miss**（勝負與比分皆錯）。

### 預測（刷新）
- **#104 決賽**：西班牙 vs 阿根廷（7/20 03:00 HKT，MetLife Stadium）
  - 主預測：**西班牙 2:1** 主勝，信心 0.56，22 處去重來源（含 Bet365/Pinnacle/DraftKings 盤口、Opta 超級電腦、官方傷兵報告、點球歷史）
  - win_prob 西 0.44 / 和 0.28 / 阿 0.28；奪冠（含加時點球）機率 西 60% / 阿 40%
  - 點球維度：penalty_risk **medium**。西班牙世界盃點球 4 敗 1 勝（史上最差之一）、阿根廷 6 勝 1 負（史上最佳），若入點球大戰明顯利阿根廷；馬丁尼斯撲點威名 + 梅西點球大戰 11/11。
  - 四家 AI 對照：MiniMax 2:1、Qwen 1:0、DeepSeek 1:1、Gemini 1:1；共識 2:1（H0.415/D0.298/A0.287）
  - 反向觀點：梅西告別劇本、阿根廷逆境韌性令部分分析師看好阿根廷 2:1。

### 指標
- 累計命中率：勝負 **59/92（64.1%）**，比分 9/92（9.9%），Brier 0.2078，ECE 0.0638。

### 同步
- 球員統計：524 人（+#103 七筆入球事件；季軍戰雙方 0 黃 0 紅）。
- Notion：#103 賽果 + #104 決賽預測共 2 頁；synced_runs 更新至 2026-07-19T0500Z。
- 網站資料：196 個預測檔同步。


## [Run #39] 2026-07-18（HKT）每日跑：#102 四強賽果（阿根廷讀秒逆轉晉級）+ #103 季軍戰 / #104 決賽預測（含點球維度）

### 新增（Added）

- **記錄 #102 四強賽果**：英格蘭 1:2 阿根廷（正規 90 分鐘分勝負）。入球：戈登（55'）、恩佐費南德斯（85'）、勞塔羅馬丁尼斯（90+2'，兩球皆梅西助攻）。黃牌：安德森（英）、利桑德羅馬丁尼斯／羅梅羅／德保羅（阿），無紅牌。**冷門**：預測英格蘭 2:1 主勝，實際阿根廷讀秒逆轉客勝晉級（verdict=miss，方向與比分皆落空）。
- **確定最後對陣**：**決賽（#104）西班牙 vs 阿根廷**（7/19 19:00 UTC）；**季軍戰（#103）法國 vs 英格蘭**（7/18 21:00 UTC）。
- **#103 季軍戰 法國 vs 英格蘭（批次 2026-07-18T0500Z，含點球維度）**：法國 2:1 英格蘭（主勝，信心 0.55，來源 13）。勝率法 50%／和 24%／英 26%；晉級（含加時點球）法 62%／英 38%。點球風險中等（法國近兩次大賽決賽點球皆負；英格蘭世界盃點球史 25% 勝率但近兩戰全勝）。附 4 家對照 AI 共識（2:1 主勝）。
- **#104 決賽 西班牙 vs 阿根廷（批次 2026-07-18T0500Z，含點球維度）**：西班牙 2:1 阿根廷（主勝，信心 0.50，來源 17）。勝率西 43%／和 29%／阿 28%；奪冠機率西 56.5%／阿 43.5%。點球風險偏高（西班牙世界盃點球史 20% 勝率；阿根廷 7 戰 6 勝、門將馬丁尼斯大賽點球不敗）。異見：部分媒體看好阿根廷與梅西告別戰敘事，若進點球更看好阿根廷。附 4 家對照 AI（DeepSeek/Gemini 傾向 1:1 和局，MiniMax/Qwen 傾向 2:1 主勝，綜合 2:1）。

### 覆盤（Post-mortems）

- 新增 #102 四強賽後覆盤：預測 2:1 主勝、實際 1:2 客勝（verdict=miss）。累計覆盤 91 篇。

### 指標（Metrics）

- 賽果方向準確率 **59/91（64.8%）**，比分完全命中 9/91（9.9%），Brier 分數 0.2073，ECE 0.0585。

### 同步（Sync）

- 網站資料同步 195 個預測檔。球員累計 523 名（本次計入 #102 七筆入球／黃牌事件）。
- Notion 同步：視本次背景執行連接器狀態而定，若未連線則暫略，待可連線時補同步。

---


## [Run #38] 2026-07-15（HKT）每日跑：#101 四強賽果（西班牙爆冷晉級決賽）+ #102 英阿當日更新預測

### 新增（Added）

- **記錄 #101 四強賽果**：法國 0:2 西班牙（正規 90 分鐘分勝負，西班牙晉級決賽）。入球：奧亞薩巴爾（22' 點球）、波路（58'）。黃牌：拉比奧（8' 法國）、古庫雷拉（約 30' 西班牙）、麥巴比（86' 法國）。無紅牌、無點球大戰。**冷門**：預測法國 2:1 主勝晉級（58.5%），實際西班牙客場完封，比分與方向皆落空（verdict=miss）。
- **確定決賽一方**：西班牙晉級 7/19 決賽（#104）；法國落入 7/18 季軍戰（#103）。#103/#104 賽程已更新已知隊伍（另一半區待 #102 英阿賽果決定）。
- **#102 英格蘭 vs 阿根廷 當日更新預測（批次 2026-07-15T0500Z，含點球維度）**：英格蘭 2:1 阿根廷（主勝，信心 0.48，來源 19，點球風險高）。勝率英格蘭 40%／和 28%／阿根廷 32%；晉級英格蘭 56%／阿根廷 44%（較昨日 55/45 微升，反映 match-day 盤口與模型差距收窄近五五波）。附 prediction.knockout 區塊（英格蘭世界盃點球勝率約 25%、阿根廷約 85.7%、門將 Emiliano Martinez 為關鍵變數）與 4 家對照 AI 共識（綜合 2:1 主勝）。

### 覆盤（Post-mortems）

- 新增 #101 四強賽後覆盤：預測 2:1 主勝、實際 0:2 客勝，方向與比分皆落空（verdict=miss）。教訓聚焦準決賽整體防守勝於個人火力、中立場不應賦予法國過高主場加成、低比分淘汰賽對單一事件（早段點球）極敏感。累計覆盤 90 篇。

### 指標（Metrics）

- 賽果方向準確率 **59/90（65.6%）**，比分完全命中 9/90（10.0%），Brier 分數 0.2079，ECE 0.0644，過度自信偏差 -0.0009。

### 同步（Sync）

- 網站資料同步 193 個預測檔（含 fixtures/results/accuracy/players/leaderboards）。球員累計 517 名（本次計入 #101 五筆入球／黃牌事件）。
- Notion 同步：本次背景執行時 Notion 連接器為未連線狀態，暫略過；批次 2026-07-15T0500Z 待下次可連線時補同步。

---


## [Run #37] 2026-07-14（HKT）每日跑：#99/#100 八強賽果 + #101/#102 四強預測

### 新增（Added）

- **記錄 #99 八強賽果**：挪威 1:2 英格蘭（加時分勝負，英格蘭晉級四強）。入球：舒爾德魯普（36' 挪威）、貝林漢（45+2' 及 93' 加時致勝，梅開二度）。黃牌：艾耶（117' 挪威）。無點球大戰。預測 1:2 客勝＝比分完全命中。
- **記錄 #100 八強賽果**：阿根廷 3:1 瑞士（加時分勝負，阿根廷晉級四強）。入球：麥亞里士打（10'）、艾華列斯（112' 加時）、勞達路（120+1' 加時）；恩多耶（67' 瑞士）。安保路（44' 黃、72' 第二面黃牌→紅牌離場）；阿爾馬達、勞達路、洛佩斯各 1 黃牌。預測 2:1 主勝＝賽果方向命中。
- **確定四強對陣並更新賽程**：#101 法國 vs 西班牙（7/14 19:00 UTC，達拉斯 AT&T Stadium）、#102 英格蘭 vs 阿根廷（7/15 19:00 UTC，亞特蘭大 Mercedes-Benz Stadium）。
- **2 場四強即將開賽預測（批次 2026-07-14T0500Z，含點球維度）**：
  - #101 法國 2:1 西班牙（主勝，信心 0.55，來源 11，點球風險中等；Opta 給法國 90 分鐘勝率 43.9% vs 西班牙 29.0%，法國晉級 58.5%／西班牙 41.5%；法國背負 2022 決賽點球負阿根廷心理變數）
  - #102 英格蘭 2:1 阿根廷（主勝，信心 0.50，來源 8，點球風險高；Opta 給英格蘭 90 分鐘勝率 39.1% vs 阿根廷 31.6%，英格蘭晉級 55%／阿根廷 45%；阿根廷點球歷史 85.7% 且門將 Emiliano Martinez 為關鍵變數）
  - 每場附 prediction.knockout 區塊與 4 家對照 AI 共識（兩場主預測皆與共識一致為 2:1 主勝）。
- **球員本屆統計更新**：#99 貝林漢梅開二度（本屆累計 6 球）、舒爾德魯普 1 球；#100 麥亞里士打、艾華列斯、勞達路各 1 球，恩多耶 1 球；安保路 1 紅牌，另多名球員黃牌（新增 3 名球員檔案，累計 515 名）。

### 覆盤（Post-mortems）

- 新增 #99、#100 兩場八強賽後覆盤（比對預測與實際）。#99 比分完全命中（1:2 客勝）；#100 賽果方向命中（預測 2:1 主勝，實際 3:1 主勝）。累計覆盤 89 篇。

### 指標（Metrics）

- 賽果方向準確率 **59/89（66.3%）**，比分完全命中 9/89（10.1%），Brier 分數 0.2082，ECE 0.059，過度自信偏差 -0.0071。

### 同步（Sync）

- 網站資料同步（192 個預測檔 + 賽程／賽果／準確率）。
- Notion 新增 #101、#102 兩頁四強預測。
- 第三方對照 AI 精簡維持 4 家（MiniMax／Qwen／DeepSeek／Gemini）。

---

## [Run #36] 2026-07-11（HKT）每日跑：#98 八強賽果 + #99/#100 八強預測

### 新增（Added）

- **記錄 #98 八強賽果**：西班牙 2:1 比利時（90 分鐘分勝負，無加時／點球，西班牙晉級四強對陣法國）。入球：法比安·魯伊斯（30'）、迪基達拿（41' 比利時）、梅利諾（88' 致勝球）。黃牌：庫巴西（43'）、迪布尼（84'）、拿波特（90+3'）、韋素（90+5'）。比利時中場奧納納因十字韌帶重傷缺陣。
- **2 場八強即將開賽預測（批次 2026-07-11T0500Z，含點球維度）**：
  - #99 挪威 1:2 英格蘭（客勝，信心 0.58，來源 23，點球風險中等；哈蘭德本屆 7 球 vs 凱恩 6 球，Opta 給挪威 37.7% 晉級機率）
  - #100 阿根廷 2:1 瑞士（主勝，信心 0.60，來源 23，點球風險中等；Opta 給阿根廷 69.4% 晉級機率，瑞士門將科貝爾點球神勇 vs 阿根廷門將馬丁尼斯點球不敗）
  - 每場附 prediction.knockout 區塊與 4 家對照 AI 共識（全數與主預測一致）。
- **球員本屆統計更新**：#98 法比安·魯伊斯、梅利諾、迪基達拿各入 1 球；庫巴西、迪布尼、拿波特、韋素各 1 黃牌（新增 4 名球員檔案）。

### 覆盤（Post-mortems）

- 新增 #98 賽後覆盤（verdict: outcome 命中）：原預測西班牙 2:0 主勝，實際 2:1，方向命中，比利時憑迪基達拿一度扳平，最終梅利諾第 88 分鐘攻入致勝球。

### 指標（Metrics）

- 累計賽果命中 **57/87（65.5%）**，完全命中比分 8/87（9.2%）。
- 校準：Brier 0.2078、ECE 0.0606、過度自信 0.0022。

---

## [Run #35] 2026-07-10（HKT）每日跑：#97 八強賽果 + #98/#99/#100 八強預測

### 新增（Added）

- **記錄 #97 八強賽果**：法國 2:0 摩洛哥（90 分鐘分勝負，無加時／點球，法國晉級四強）。姆巴佩第 60 分鐘、登貝萊第 66 分鐘各入一球；姆巴佩上半場（28'）射失一個 VAR 判予的十二碼，遭摩洛哥門將布諾撲出。
- **3 場八強即將開賽預測（批次 2026-07-10T0500Z，含點球維度）**：
  - #98 西班牙 2:0 比利時（主勝，信心 0.72，來源 11，點球風險低；比利時中場奧納納十字韌帶重傷缺陣）
  - #99 挪威 1:2 英格蘭（客勝，信心 0.60，來源 10，點球風險中等；哈蘭德本屆 7 球 vs 凱恩 6 球，Opta 給挪威 37.7% 晉級機率）
  - #100 阿根廷 2:1 瑞士（主勝，信心 0.68，來源 10，點球風險中等；瑞士門將科貝爾點球神勇）
  - 每場附 prediction.knockout 區塊與 4 家對照 AI 共識（全數與主預測一致）。
- **球員本屆統計更新**：#97 姆巴佩、登貝萊各入 1 球（姆巴佩累計 8 球，與美斯並列射手榜首），迪奧普 1 黃牌。

### 變更（Changed）

- **多模型對照精簡至 4 家（MiniMax／Qwen／DeepSeek／Gemini）**：同步 skill 於 2026-07-07 的成本優化決策，將 `multimodel_predict.py` 的 MODELS 清單由 7 家降為 4 家，移除 GPT-5.1-thinking、Grok-4.20-reasoning（reasoning 模型 token 消耗最高）與 GLM-4.7（與 DeepSeek 高度重疊），以節省每場對照的 token 開銷。此前腳本與 skill 規則不一致，本次修正對齊。

### 覆盤（Post-mortems）

- 新增 #97 賽後覆盤（verdict: outcome 命中）：原預測法國 2:1 主勝，實際 2:0，方向命中且比分落於預測第二熱門「2:0」選項。

### 指標（Metrics）

- 累計賽果命中 **56/86（65.1%）**，完全命中比分 8/86（9.3%）。
- 校準：Brier 0.2084、ECE 0.0578、過度自信 0.0057。

---

## [Run #34] 2026-07-09（HKT）每日跑：#93-96 16 強賽果 + #97/#98 八強預測

### 新增（Added）

- **記錄 4 場 16 強賽果（#93-96）**：#93 葡萄牙 0:1 西班牙（梅里諾第 91 分鐘絕殺，西班牙晉級；C·朗拿度世界盃告別戰）、#94 美國 1:4 比利時（迪基達利亞梅開二度，比利時大勝晉級）、#95 阿根廷 3:2 埃及（一度 0:2 落後，靠羅梅羅第 79、美斯第 83、恩素第 92 分鐘連追三球逆轉；美斯射失十二碼仍晉級）、#96 瑞士 0:0 哥倫比亞（十二碼 4:3，哥貝爾撲出古卓射門，華爾加斯主射制勝，瑞士晉級）。前三場 90 分鐘分勝負，#96 經點球大戰。
- **2 場八強即將開賽預測（批次 2026-07-09T0500Z，含點球維度）**：#97 法國 2:1 摩洛哥（主勝，信心 0.72，來源 51 處，點球風險中等）、#98 西班牙 2:0 比利時（主勝，信心 0.70，來源 37 處，點球風險中等）。每場附 prediction.knockout 區塊與 7 家對照 AI 共識（兩場對照 AI 全數看好主隊晉級）。
- **確定八強對陣表**：#97 法國 vs 摩洛哥、#98 西班牙 vs 比利時、#99 挪威 vs 英格蘭、#100 阿根廷 vs 瑞士；fixtures.json 更新 #97-100 真實對陣。
- **球員本屆統計更新**：#93-96 入球者與紅黃牌事件合併（烏龍球不計），新增 21 筆事件（美斯本場 1 球累計 8 球續居射手榜首、迪基達利亞本場 2 球、恩素/羅梅羅各 1 球），重算射手榜與紀律榜（現 508 名球員）。

### 覆盤（Post-mortems）

- 新增 #93-96 四場賽後覆盤。#93、#95 **命中賽果（outcome）**；#94 **失準（miss）**（原預測美國勝，比利時卻大勝）；#96 **失準（miss）**（原預測哥倫比亞勝，惟 90 分鐘和局計為失準，AI 已正確標示 point 球風險高、信心僅 0.45）。

### 指標（Metrics）

- 累計賽果命中 **55/85（64.7%）**，完全命中比分 **8/85（9.4%）**。
- 校準：Brier 0.2087、ECE 0.0552、過度自信 0.0091。
- 基準線對照：本站主預測賽果命中 55/85 續居各來源之首，Brier 0.2087 亦為領先群。

---

## [Run #33] 2026-07-06（HKT）每日跑：#91/#92 賽果 + #95/#96 16 強預測

### 新增（Added）

- **記錄 2 場 16 強賽果（#91、#92）**：#91 巴西 1:2 挪威（哈蘭德第 79、90 分鐘梅開二度逆轉，挪威隊史首入八強、本屆最大冷門之一；尼馬補時十二碼扳一城，將對戰英格蘭）、#92 墨西哥 2:3 英格蘭（貝連堅兩分鐘內連入兩球，英格蘭雖第 54 分鐘關沙領紅十人應戰仍勝出晉級八強）。兩場皆 90 分鐘分勝負。
- **2 場 16 強即將開賽預測（批次 2026-07-06T0500Z，含點球維度）**：#95 阿根廷 2:0 埃及（主勝，信心 0.78，點球風險 low）、#96 瑞士 0:1 哥倫比亞（客勝，信心 0.45，點球風險 high）。每場附 prediction.knockout 區塊與 7 家對照 AI 共識（來源各 43 處）。
- **球員本屆統計更新**：#91/#92 入球者與紅黃牌事件合併（烏龍球不計），新增 13 筆事件（含哈蘭德本場 2 球、貝連堅本場 2 球、關沙紅牌），重算射手榜與紀律榜（現 497 名球員）。

### 覆盤（Post-mortems）

- 新增 #91、#92 兩場賽後覆盤。#91 **失準（miss）**：AI 與博彩、7 家第三方共識全數看好巴西，卻遭哈蘭德單場爆發＋巴西失常掀翻，屬市場級集體誤判。#92 **命中賽果（outcome）**：正確判斷英格蘭客勝晉級，僅比分因紅牌後更開放而略保守。

### 指標（Metrics）

- 累計賽果命中 **53/81（65.4%）**，完全命中比分 **8/81（9.9%）**。
- 校準：Brier 0.2101、ECE 0.0609、過度自信 0.006。
- 基準線對照：本站主預測賽果命中 53/81 續居各來源之首，Brier 0.2101 亦為領先群。

### 備註（Note）

- 每日一次 13:00 HKT 排程正常執行（恢復後第 2 跑 run #2）。#93/#94 沿用 7/5 已達 ≥40 來源之預測，未重複研究以節省成本。

---

## [Run #32] 2026-07-05（HKT）每日跑：#89/#90 賽果 + #93/#94 16 強預測

### 新增（Added）

- **記錄 2 場 16 強賽果（#89、#90）**：#89 巴拉圭 0:1 法國（Mbappé 第 70 分鐘十二碼，法國晉級八強對摩洛哥）、#90 加拿大 0:3 摩洛哥（Ounahi 梅開二度 + Rahimi 補時破門，摩洛哥晉級）。兩場皆 90 分鐘分勝負。
- **2 場 16 強即將開賽預測（批次 2026-07-05T0500Z，含點球維度）**：#93 葡萄牙 1:2 西班牙（客勝，信心 0.55，點球風險 high）、#94 美國 2:1 比利時（主勝，信心 0.50，點球風險 medium）。每場附 prediction.knockout 區塊與 7 家對照 AI 共識。
- **球員本屆統計更新**：#89/#90 入球者與紅黃牌事件合併（烏龍球不計），新增 13 筆事件、自動建檔 6 名新球員，重算射手榜與紀律榜。

### 覆盤（Post-mortems）

- 新增 #89、#90 兩場賽後覆盤：兩場皆**命中賽果**（晉級方正確）但未完全命中比分。#89 法國僅 1:0 小勝（預測 0:3 高估進球）、#90 摩洛哥 3:0 完勝（預測 1:2 低估火力）。

### 指標（Metrics）

- 累計賽果命中 **52/79（65.8%）**，完全命中比分 **8/79（10.1%）**。
- 校準：Brier 0.2072、ECE 0.0761。

### 備註（Note）

- 每日一次 13:00 HKT 經常性預測排程已於 7/5 恢復並正常執行（本次為恢復後首跑 run #1）。

---


## [Run #31] 2026-07-04（HKT）補跑：16 場 32 強賽果全數記錄・4 場 16 強預測・排程恢復

### 新增（Added）

- **記錄全部 16 場 32 強淘汰賽賽果（#73–#88）**：因 7/1 排程因沙盒故障未執行，本次一次補齊。含加時／點球大戰處理——#74 德國 1:1 巴拉圭（點球 3:4，巴拉圭晉級）、#75 荷蘭 1:1 摩洛哥（點球 2:3，摩洛哥晉級）、#82 比利時 3:2 塞內加爾（加時晉級）、#86 阿根廷 3:2 維德角（加時晉級）、#88 澳洲 1:1 埃及（點球 2:4，埃及晉級）。其餘 11 場依 90 分鐘分勝負。
- **4 場 16 強即將開賽預測（含點球維度）**：批次 `2026-07-04T0517Z`——#89 巴拉圭 vs 法國（0:3 客勝，信心 0.87，點球風險 low）、#90 加拿大 vs 摩洛哥（1:2 客勝，信心 0.62，點球風險 high）、#91 巴西 vs 挪威（2:1 主勝，信心 0.63，點球風險 medium）、#92 墨西哥 vs 英格蘭（1:2 客勝，信心 0.55，點球風險 medium）。每場附 `prediction.knockout` 區塊與 7 家對照 AI 共識。
- **16 強對陣表寫入 `fixtures.json`（#89–#96）**：#89 巴拉圭vs法國、#90 加拿大vs摩洛哥、#91 巴西vs挪威、#92 墨西哥vs英格蘭、#93 葡萄牙vs西班牙、#94 美國vs比利時、#95 阿根廷vs埃及、#96 瑞士vs哥倫比亞。
- **球員本屆統計更新**：32 強入球者與紅黃牌事件合併（烏龍球不計），新增 51 筆事件、自動建檔 14 名新球員（含中文名），重算射手榜與紀律榜。

### 覆盤（Post-mortems）

- 新增 9 場已預測 32 強賽事的賽後覆盤（#73–#78、#83–#85）：**4 場完全命中比分**（#76、#78、#83、#85）、**3 場命中賽果**（#73、#77、#84）、**2 場失手**（#74、#75，皆為點球大戰爆冷，7 家對照 AI 亦全數失手）。

### 變更（Changed）

- **恢復每日一次經常性預測**：自 **7/5 起**恢復每日 13:00 HKT（UTC `0 5 * * *`）自動預測排程；6/29–7/4 的暫停與兩次性補跑階段結束。

### 指標（Metrics）

- 累計賽果命中 **50/77（64.9%）**，完全命中比分 **8/77（10.4%）**；淘汰賽階段 7/9 賽果命中、4/9 完全命中。
- 校準：Brier 0.2093、ECE 0.0714。
...
## [補充批次] 2026-06-28（HKT）補做 5 場 32 強預測・排程調整

### 新增（Added）

- **補做 5 場 32 強預測（含點球維度）**：因應排程調整（明日起暫停每日預測，下次為 7/1 與 7/4），預先補做即將開賽、否則會落入空檔的 5 場淘汰賽預測——#77 法國 vs 瑞典（2:1 主勝，點球風險 low）、#78 象牙海岸 vs 挪威（1:2 客勝，點球風險 high，本組最難預測）、#83 葡萄牙 vs 克羅埃西亞（2:1 主勝，點球風險 high，克羅埃西亞世界盃點球 4 戰 4 勝）、#84 西班牙 vs 奧地利（2:0 主勝，點球風險 low）、#85 瑞士 vs 阿爾及利亞（2:0 主勝，點球風險 high，瑞士點球史 6 戰 1 勝）。每場附 `prediction.knockout` 區塊與 7 家對照 AI 共識。批次 `2026-06-28T0500Z`（Run #30 延伸批次）。

### 變更（Changed）

- **排程調整**：自 6/29 起暫停每日預測。下兩次預測排定於 **7/1 13:00 HKT** 與 **7/4 13:00 HKT**（兩次性任務），**7/5 起恢復每日 13:00 HKT** 經常性預測。

### 指標（Metrics）

- 累計命中維持 43/68（63.2%）；5 場新預測尚無賽果，待開賽後納入評分。

---



## [賽事更新] 2026-06-28（HKT）小組賽收官・32 強淘汰賽開打

### 新增（Added）

- **小組賽全部結束**：寫入 #67–#72 共 6 場最終賽果（克羅埃西亞 2:1 迦納、巴拿馬 0:2 英格蘭、哥倫比亞 0:0 葡萄牙、剛果民主共和國 3:1 烏茲別克、約旦 1:3 阿根廷、阿爾及利亞 3:3 奧地利）。梅西對約旦攻入個人世界盃生涯第 19 球創紀錄。
- **32 強對陣表完成**：依各組最終排名與 8 隊最佳第三名，補齊 #73–#88 全部對陣（fixtures.json）。
- **首批 32 強預測（含點球維度）**：#73 南非 vs 加拿大、#74 德國 vs 巴拉圭、#75 荷蘭 vs 摩洛哥、#76 巴西 vs 日本。每場新增 `prediction.knockout` 區塊（近 5 年點球大戰數據、心理素質、加時/點球/晉級機率、penalty_risk）。#75 荷蘭 vs 摩洛哥點球風險評為 high。
- **6 場賽後覆盤 + 球員統計更新**：射手榜由梅西領跑（本屆 6 球）。
...
- **「預測演變」頁（`TrendsTab.tsx`）說明文字重寫**：明確說明演變僅適用於「開賽前被預測超過一次（≥2 批次）」的比賽；自 2026-06-23 預測改為每日一次後，多數比賽只有單一批次、不會出現於此頁，**屬正常情形而非資料停止更新**。
- 演變頁頂部說明與空狀態提示均加上說明，避免訪客誤會「停在 #28」是 bug。

### 說明（Note）

- 根因：預測演變依賴同一場比賽多個預測批次；賽程 #29 起每場只在開賽前 48h 窗口內被觸發一次，故只有單一批次。本次不改變預測頻率（維持每日一次省成本），僅釐清文案。
...
- **成本優化（方案 A + D + E）**：
  - **A — 來源數門檻**：≥100（≤36h）/ ≥50（48h）降為 **≥40 / ≥25**。
  - **D — 執行頻率**：每日兩次 07:00/19:00 HKT（`0 11,23 * * *`）降為 **每日一次 13:00 HKT（`0 5 * * *`）**；淘汰賽（32 強起）同樣維持每日一次。
  - **E — 合併研究子代理**：同一次 run 的多場盡量用一個 Sonnet 4.6 研究子代理一次研究（>3 場分 2 組），降低啟動與重複搜尋開銷。
  - **第三方對照 AI 維持 7 家不砍**；主預測仍為 Claude Sonnet 4.6。
  - 定時任務 `c53acfd7` 與技能 `wc2026-prediction-automation` 同步更新。
- **Runbook 納入 repo 並自動同步**：`CRON_RUNBOOK.md` 更新為成本優化版；`push_to_github.py` 新增根目錄參考文檔同步區塊，未來每次推送都會自動把最新 `CRON_RUNBOOK.md` 同步到 repo 作參考。

詳見 `RELEASE_NOTES_2026-06-23-cost-optimization.md`。

---

## [資料更新] 2026-06-23（HKT）預測批次 2026-06-22T2300Z（第 25 次）

### 新增（Added）

- **新預測（4 場，均含 7 家第三方 AI 對照）**：
  - 第 49 場 波黑 2:0 卡塔爾（Group B，主勝，58/22/20，信心 0.62，86 來源；AI 共識 1:0）。
  - 第 50 場 瑞士 1:1 加拿大（Group B，和局，38/33/29，信心 0.55，82 來源；AI 共識 2:1）。
  - 第 51 場 蘇格蘭 0:2 巴西（Group C，客勝，10/20/70，信心 0.72，100 來源；AI 共識 0:2）。
  - 第 52 場 摩洛哥 3:0 海地（Group C，主勝，82/13/05，信心 0.82，95 來源；AI 共識 2:0）。
- **新結果（1 場）**：
  - 第 41 場 阿根廷 2:0 奧地利（主勝，預測 2:1，勝負命中、比分未中；梅西 38'、90+5' 梅開二度，生涯第 18 個世界盃進球破克洛茨紀錄，但第 9 分鐘罰失十二碼）。
- **未計入（中斷）**：第 42 場 法國 v 伊拉克因費城雷暴中斷（上半場 1:0，姆巴佩 14'），FIFA 季連未完賽，本輪不記入最終結果，待補賽完成後补上。
- **賽後覆盤**：新增 1 篇（#41），累計 37 篇。
- **球員統計**：新增本屆事件（梅西 2 球等），名單擴至 404 人，射手榜 89 人、紀律榜 107 人。

### 指標（Metrics）

- 累計評估 37 場：勝負命中 22/37（59.5%）、完全比分命中 3/37（8.1%）。
- 校準：Brier 0.245、ECE 0.0981、過度自信 0.0505。
- 基準線逐場明細已重算（max_match_completed = 41）。

---

## [資料更新] 2026-06-22（HKT）預測批次 2026-06-22T1100Z（第 24 次）

### 新增（Added）

- **新預測（1 場，含 7 家第三方 AI 對照）**：
  - 第 48 場 哥倫比亞 2:1 剛果民主共和國（Group K，主勝，60/23/17，信心 0.68，81 來源；AI 共識 2:0）。
- **新結果（2 場）**：
  - 第 39 場 烏拉圭 2:2 佛得角（和局，預測 1:0 主勝，失準；佛得角二度扳平爆冷）。
  - 第 40 場 紐西蘭 1:3 埃及（客勝，預測 0:2，勝負命中、比分未中；薩拉赫 67' 入球、特雷澤蓋 82' 鎖定勝局）。
- **賽後覆盤**：新增 2 篇（#39 #40），累計 36 篇。
- **球員統計**：新增本屆事件（薩拉赫、特雷澤蓋、Zico、Surman、Araújo、Canobbio、Pina、Varela 等入球者與多名黃牌），名單擴至 401 人，射手榜 89 人、紀律榜 103 人。

### 指標（Metrics）

- 累計評估 36 場：勝負命中 21/36（58.3%）、完全比分命中 3/36（8.3%）。
- 校準：Brier 0.2478、ECE 0.1086、過度自信 0.0597。
- 基準線逐場明細已重算（max_match_completed = 40）。

---

## [資料更新] 2026-06-22（HKT）預測批次 2026-06-21T2300Z（第 23 次·補跑）

> 注：06-21 晚間與深夜兩次排程因組織信用額度耗盡而跳過；本次於 06-22 早間一次補齊累積的結果與預測。

### 新增（Added）

- **新預測（5 場，均含 7 家第三方 AI 對照）**：
  - 第 43 場 挪威 2:1 塞內加爾（Group I，主勝，44/27/29，信心 0.62，110 來源；AI 共識 2:1）。
  - 第 44 場 約旦 1:2 阿爾及利亞（Group J，客勝，18/24/58，信心 0.65，112 來源；AI 共識 1:2）。
  - 第 45 場 葡萄牙 3:1 烏茲別克（Group K，主勝，74/16/10，信心 0.79，60 來源；AI 共識 3:0）。
  - 第 46 場 英格蘭 2:0 迦納（Group L，主勝，77/14/9，信心 0.81，60 來源；AI 共識 2:0）。
  - 第 47 場 巴拿馬 0:2 克羅地亞（Group L，客勝，14/22/64，信心 0.72，60 來源；AI 共識 0:2）。
- **新結果（4 場）**：
  - 第 35 場 厄瓜多爾 0:0 古拉索（和局，預測 3:0 主勝，失準）。
  - 第 36 場 突尼西亞 0:4 日本（客勝，預測 0:2，勝負命中、比分未中）。
  - 第 37 場 西班牙 4:0 沙烏地阿拉伯（主勝，預測 2:0，勝負命中、比分未中）。
  - 第 38 場 比利時 0:0 伊朗（和局，預測 2:1 主勝，失準；比利時恩戈伊 66' 染紅）。
- **賽後覆盤**：新增 #35-#38 四場繁中覆盤。
- **球員統計**：新增日本上田綠世（2 球）、鐶田大地、伊東純也；西班牙亞馬爾、奧亞薩瓦爾（2 球）；比利時恩戈伊紅牌等；射手榜 81 人、紀律榜 96 人。

### 變更（Changed）

- 命中率：已評估 34 場，勝負命中 20/34（58.8%），比分精準 3/34（8.8%）。
- 校準：Brier 0.2441、ECE 0.105、過度自信 0.0532。
